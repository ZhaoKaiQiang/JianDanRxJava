...
public class ImageDetailActivity extends BaseActivity implements LoadFinishCallBack {
    ...
    protected void loadData() {
            ...
            ImageLoadProxy.displayImage4Detail(img_urls[0], img, new
                    SimpleImageLoadingListener() {
                        ...
                        public void onLoadingFailed(String imageUri, View view, FailReason failReason) {
                            progress.setVisibility(View.GONE);
                            ToastHelper.Short("加载失败" + failReason.getType().name());
                        }
                    });
        ...
        img.setOnViewTapListener((view, x, y) -> toggleBar());
    }
